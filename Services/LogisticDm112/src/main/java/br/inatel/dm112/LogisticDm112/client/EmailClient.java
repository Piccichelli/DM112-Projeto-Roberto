...
import br.inatel.dm112.LogisticDm112.model.MailRequestData;
...
public class EmailClient {
	...
	public void callSendMailService(int orderNumber, String text) {

		String url = restURL + mailEndpoint ;
		System.out.println("URL: " + url);
		
		MailRequestData mrd = new MailRequestData(orderNumber, sendToAddress, text);
